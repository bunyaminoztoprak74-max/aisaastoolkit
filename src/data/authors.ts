...
export const allAuthors: Author[] = [
  ...
  },
  {
    ...
    bio: "Sarah Chen specializes in AI-powered voice synthesis, video generation, and multimedia production tools. With a background in broadcast media and content creation, she evaluates AI tools from a creator's perspective — focusing on output quality, ease of use, and real-world production value. Every voice and audio tool is tested for a minimum of 2-3 weeks across real narration, podcast, and dubbing projects before publishing a verdict, with side-by-side listening tests against competing tools rather than relying on vendor demos. Sarah maintains active subscriptions to ElevenLabs, Murf AI, and Descript for ongoing comparison as pricing and features change. Pricing and feature data re-verified at publication. Last methodology review: August 2026.",
    shortBio: "Multimedia content creator turned AI tools reviewer. 2-3 week hands-on testing for every AI voice and video tool.",
