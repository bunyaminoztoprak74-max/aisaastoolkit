...
export const tagToolMap: Record<string, string[]> = {
  "free-plan":           ["claude", "chatgpt", "writesonic", "zapier", "perplexity", "make-com", "gemini", "cursor"],
  "under-20":            ["claude", "chatgpt", "writesonic", "make-com", "perplexity", "gemini", "cursor"],
  "enterprise":          ["jasper", "zapier", "make-com", "gemini", "cursor"],
  "pay-per-use":         ["claude", "chatgpt"],
  "no-code":             ["make-com", "zapier", "pictory", "writesonic", "jasper"],
  "api-access":          ["claude", "chatgpt", "make-com", "zapier", "jasper", "writesonic", "perplexity", "gemini", "cursor"],
  "long-context":        ["claude", "perplexity", "gemini"],
  "web-search":          ["chatgpt", "perplexity", "writesonic", "gemini"],
  "image-generation":    ["chatgpt", "jasper", "writesonic", "gemini"],
  "code-generation":     ["claude", "chatgpt", "perplexity", "gemini", "cursor"],
  "voice-mode":          ["chatgpt", "gemini"],
  "team-collab":         ["jasper", "make-com", "zapier", "chatgpt", "gemini"],
  ...
  "content-marketing":   ["claude", "chatgpt", "jasper", "writesonic", "pictory", "gemini"],
  "seo-writing":         ["jasper", "writesonic", "perplexity", "claude", "gemini"],
  "video-creation":      ["pictory"],
  "workflow-automation": ["make-com", "zapier"],
  "research":            ["perplexity", "claude", "chatgpt", "gemini"],
  ...
  "solopreneur":         ["claude", "chatgpt", "writesonic", "make-com", "pictory", "perplexity", "gemini", "cursor"],
  "agency":              ["jasper", "make-com", "zapier", "pictory"],
  "developer":           ["claude", "chatgpt", "make-com", "zapier", "cursor"],
