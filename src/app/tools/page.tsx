...
export const metadata: Metadata = buildMetadata({
  ...
  description: "Browse our complete database of 19+ AI tool reviews. Filter by category, price, rating, and features to find the perfect AI tool for your needs.",
  path: "/tools",
